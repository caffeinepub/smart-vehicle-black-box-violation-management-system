...
async function generatePDF(
  ...
  doc.text(
    "Violation detected and reported by SAFEWAY Smart Vehicle Blackbox Monitoring System.",
    PAGE_W / 2,
    285,
    { align: "center" },
  );
...
export default function ChallanPreviewModal({
  ...
  const evidenceImage = relevantViolations.find((v) => v.imageUrl)?.imageUrl;
      ...
      >
        ...
        <div className="p-6 space-y-5">
          ...
          <p
            ...
            style={{ color: "#9ca3af" }}
          >
            Violation detected and reported by SAFEWAY Smart Vehicle Blackbox
            Monitoring System. Cooperated with Kerala Motor Vehicle Department.
          </p>
        </div>
